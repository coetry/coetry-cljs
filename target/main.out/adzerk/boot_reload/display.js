...
var attr = cljs.core.nth.call(null,vec__11643,(0),null);
...
var len__9102__auto___11650 = arguments.length;
var i__9103__auto___11651 = (0);
while(true){
if((i__9103__auto___11651 < len__9102__auto___11650)){
args__9109__auto__.push((arguments[i__9103__auto___11651]));

var G__11652 = (i__9103__auto___11651 + (1));
i__9103__auto___11651 = G__11652;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__9110__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq11649){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11649));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__11653){
...
var data = map__11654__$1;
var message = cljs.core.get.call(null,map__11654__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__11654__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__11654__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__11656 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__11656,goog.events.EventType.CLICK,((function (G__11656,map__11654,map__11654__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__11656,map__11654,map__11654__$1,data,message,line,file))
);

return G__11656;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__11657){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__11661){
...
var messages = map__11662__$1;
var warnings = cljs.core.get.call(null,map__11662__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__11662__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__11664 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__11664,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__11664,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__11665){
...
var messages = map__11666__$1;
var warnings = cljs.core.get.call(null,map__11666__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__11666__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__11666,map__11666__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__11666,map__11666__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__11666,map__11666__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__11666,map__11666__$1,messages,warnings,exception))
;
