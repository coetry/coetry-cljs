...
var and__7921__auto__ = !(("#" === ch));
if(and__7921__auto__){
var and__7921__auto____$1 = !(("'" === ch));
if(and__7921__auto____$1){
var and__7921__auto____$2 = !((":" === ch));
if(and__7921__auto____$2){
...
if(cljs.core.truth_((function (){var and__7921__auto__ = validate_leading_QMARK_;
...
var G__11372 = (function (){var G__11370 = sb;
G__11370.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__11370;
})();
var G__11373 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__11372;
ch = G__11373;
continue;
}
...
var temp__4655__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__11374 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__11374,ch);
...
var or__7933__auto____$1 = cljs.tools.reader.edn.macros.call(null,ch);
...
var vec__11382 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__11382,(0),null);
var start_column = cljs.core.nth.call(null,vec__11382,(1),null);
...
var G__11386 = ((!((mret === rdr)))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__11386;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__11385 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__11385,ch);

return G__11385;
})(),true,null,opts);
var G__11387 = ((!((o === rdr)))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__11387;
continue;
}
}
...
var vec__11388 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__11388,(0),null);
var start_column = cljs.core.nth.call(null,vec__11388,(1),null);
...
var G__11394 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__11393;
ch = G__11394;
continue;
}
...
while(true){
var G__11397 = ch;
if(cljs.core._EQ_.call(null,null,G__11397)){
...
if(cljs.core._EQ_.call(null,"\\",G__11397)){
var G__11400 = (function (){var G__11398 = sb;
G__11398.append(cljs.tools.reader.edn.escape_char.call(null,sb,rdr));

return G__11398;
})();
var G__11401 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__11400;
ch = G__11401;
continue;
} else {
...
var G__11402 = (function (){var G__11399 = sb;
G__11399.append(ch);

return G__11399;
})();
var G__11403 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__11402;
ch = G__11403;
continue;
...
break;
default:
var or__7933__auto__ = (function (){var temp__4657__auto____$1 = cljs.tools.reader.impl.commons.parse_symbol.call(null,token);
...
return cljs.core._conj.call(null,(function (){var x__8795__auto____$1 = cljs.tools.reader.edn.read.call(null,rdr,true,null,opts);
...
var G__11407 = rdr;
cljs.tools.reader.edn.read.call(null,G__11407,true,null,true);
...
var temp__4655__auto__ = (function (){var G__11408 = token;
var G__11408__$1 = (((G__11408 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__11408));
if((G__11408__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__11408__$1);
}
})();
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4655__auto__ = (function (){var or__7933__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"readers","readers",-2118263030).cljs$core$IFn$_invoke$arity$1(opts),tag);
if(cljs.core.truth_(or__7933__auto__)){
return or__7933__auto__;
} else {
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__11415,reader){
var map__11416 = p__11415;
...
var eof = cljs.core.get.call(null,map__11416__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
